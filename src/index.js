...
prefabs.player(entities, 0, 100, 300, 0x00AAFF, 0);
prefabs.player(entities, 1, 700, 300, 0xFF00AA, Math.PI);
prefabs.player(entities, 2, 400, 100, 0xAAFF00, Math.PI / 2);
prefabs.player(entities, 3, 400, 500, 0xAA00FF, Math.PI * 3 / 2);
